...
try:
    try:
        express = (soup.select(
            "tbody.providerList_f1mjsvhw > tr:nth-of-type(2) > td:nth-of-type(1) > div.fnsgms5")[0].text)
        economy = (soup.select(
            "tbody.providerList_f1mjsvhw > tr:nth-of-type(2) > td:nth-of-type(2) > div.fnsgms5")[0].text)
    except:
    ...
    print("Current express rate: {}, economy rate: {}".format(
        currentRateExpress[0], currentRateEconomy[0]))
